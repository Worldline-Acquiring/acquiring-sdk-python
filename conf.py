...
project = 'acquiring-sdk-python'
copyright = 'Copyright (c) 2024 Worldline Financial Services (Europe) SA'
...
htmlhelp_basename = 'acquiring-sdk-pythondoc'
...
latex_documents = [
    (master_doc, 'acquiring-sdk-python.tex', 'acquiring-sdk-python Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'acquiring-sdk-python', 'acquiring-sdk-python Documentation',
     [author], 1)
]
