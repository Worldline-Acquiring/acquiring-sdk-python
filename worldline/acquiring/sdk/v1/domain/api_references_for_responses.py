...
class ApiReferencesForResponses(DataObject):
    ...
    __scheme_transaction_link_id: Optional[str] = None
    ...
    @property
    def scheme_transaction_link_id(self) -> Optional[str]:
        """
        ...
        Type: str
        """
        return self.__scheme_transaction_link_id

    @scheme_transaction_link_id.setter
    def scheme_transaction_link_id(self, value: Optional[str]) -> None:
        self.__scheme_transaction_link_id = value
    ...
    def to_dictionary(self) -> dict:
        ...
        if self.scheme_transaction_link_id is not None:
            dictionary['schemeTransactionLinkId'] = self.scheme_transaction_link_id
        return dictionary
    ...
    def from_dictionary(self, dictionary: dict) -> 'ApiReferencesForResponses':
        ...
        if 'schemeTransactionLinkId' in dictionary:
            self.scheme_transaction_link_id = dictionary['schemeTransactionLinkId']
        return self
