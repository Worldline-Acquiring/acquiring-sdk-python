...
class SubsequentCardOnFileData(DataObject):
    ...
    __initial_scheme_transaction_link_id: Optional[str] = None
    ...
    @property
    def initial_scheme_transaction_link_id(self) -> Optional[str]:
        """
        | A unique transaction identifier generated by Mastercard to provide consistent linking of related transaction activity throughout the transaction lifecycle.

        Type: str
        """
        return self.__initial_scheme_transaction_link_id

    @initial_scheme_transaction_link_id.setter
    def initial_scheme_transaction_link_id(self, value: Optional[str]) -> None:
        self.__initial_scheme_transaction_link_id = value
    ...
    def to_dictionary(self) -> dict:
        ...
        if self.initial_scheme_transaction_link_id is not None:
            dictionary['initialSchemeTransactionLinkId'] = self.initial_scheme_transaction_link_id
    ...
    def from_dictionary(self, dictionary: dict) -> 'SubsequentCardOnFileData':
        ...
        if 'initialSchemeTransactionLinkId' in dictionary:
            self.initial_scheme_transaction_link_id = dictionary['initialSchemeTransactionLinkId']
