...
def create_post_request():
    ...
    return {'card': {'cardSecurityCode': '123', 'cardNumber': '1234567890123456', 'expiryDate': '122024'}}
...
def getWithQueryParams_request(request, test):
    ...
    test.assertTrue(len(list(filter((lambda header: header[0] == 'X-WL-ServerMetaInfo'), headers))))
